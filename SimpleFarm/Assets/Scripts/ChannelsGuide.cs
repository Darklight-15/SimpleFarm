...
public class ChannelsGuide : MonoBehaviour {
    ...
    public GameObject ActualGameObjectSelected;
    ...
    void InitializeValues() {
        ...
        //Clock
        Hour = 12;
        Clock = GameObject.Find("Clock").transform.Find("Text").GetComponent<Text>();
    ...
    private IEnumerator Initialize()
    {
        ...
        EvSys.firstSelectedGameObject = GameObject.Find("Reporte0-0");

        EvSys.SetSelectedGameObject(EvSys.firstSelectedGameObject);
        ActualGameObjectSelected = EvSys.firstSelectedGameObject;
    ...
    public void SetProgramationToHour(int hour)
    {
        ...
        if (hour == 12) pass = 0; else pass = hour;
